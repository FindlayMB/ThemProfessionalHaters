...
locals {
  function_name_SS_get_dates = "SS_get_dates"
  function_name_SS_get_schedule = "SS_get_schedule"
  function_name_SS_add_dates = "SS_add_dates"
  function_name_SS_add_schedule = "SS_add_schedule"
  handler_name  = "main.lambda_handler"
  artifact_name_add_schedule = "SS_add_schedule_artifact.zip"
  artifact_name_add = "SS_add_artifact.zip"
  artifact_name_get = "SS_get_artifact.zip"
  artifact_name_get_schedule = "SS_get_artifact.zip"
}
